...
bob@ml_r2022b:~$ ln -s /opt/matlab/R2022b/bin/matlab ~/bin/matlab
```
...
<p><a name="annex-systemd-run-matlab"></a></p>
...
<p><a name="pps-xhost-MIT-SHM"></a></p>
